...
示例：
  ...
  python run.py "蔡不菜（AI版）" --skip-env
    ...
    if user_mode == "A":
        ...
        expected_soul = f"{blogger_safe}_创作指南.skill/SOUL.md"
    else:
        expected_skill = f"{blogger_safe}_创作基因.skill/SKILL.md"
        expected_soul = f"{blogger_safe}_创作基因.skill/SOUL.md"
    ...
    print(f"  🧬 表达 DNA 文件: {expected_soul}")
    print()
